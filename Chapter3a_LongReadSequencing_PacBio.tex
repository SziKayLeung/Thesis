...
\begin{figure}[!htp]
	...
	{\textbf{Detailed Iso-Seq lab workflow for SMRTbell library preparation.} Shown is a flow diagram of the Iso-Seq lab workflow for library preparation:
		\begin{enumerate}
			\item Repair DNA by filling-in abasic sites, removing thymine dimers, oxidising guanines and deaminating cytosines. This is essential to ensure a continuous sequence for uninterrupted polymerase processivity.
