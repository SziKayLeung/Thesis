...
Reverse Transcription switch is determined on a junction level on both plus and minus strands by aligning each splice junction to reference file (splice junction defined as 3’/end of the exon to the 3’/end of the intron). The transcript is considered to be an artifact of reverse transcription if any of the junctions were labelled as RT switch. 
