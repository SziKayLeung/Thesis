...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=3,trim={2cm 28cm 2cm 5cm},clip,scale = 0.45]{ProjectDevelopment_Figures}
	\end{center}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=4,trim={2cm 35cm 0 1cm},clip, scale = 0.55]{ProjectDevelopment_Figures}
	\end{center}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=8,trim={2cm 32cm 0 1cm},clip, scale = 0.4]{ProjectDevelopment_Figures}
	\end{center}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=10,trim={0cm 0cm 0 0cm},clip, scale = 0.45]{ProjectDevelopment_Figures}
	\end{center}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[htp]
	\centering
	\includegraphics[page=9,trim={0cm 21cm 0cm 0cm},clip,scale = 0.45]{ProjectDevelopment_Figures}
