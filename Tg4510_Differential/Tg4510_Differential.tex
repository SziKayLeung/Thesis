...
%Integrative functional genomic analysis of intron retention in human and mouse brain with Alzheimer's disease - Li - 2021 - Alzheimer's &amp; Dementia - Wiley Online Library
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=3,trim={1cm 17cm 0cm 0cm},clip,scale = 0.45]{Tg4510_diff_figures.pdf}
	\end{center}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=1,trim={1cm 20cm 0cm 0cm},clip,scale = 0.55]{AltFigures_Diff.pdf}
	\end{center}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[page=5,trim={0 20cm 0 0},clip,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[page=6,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\captionsetup{width=0.95\textwidth}
...
\clearpage
\boldheader{Iso-Seq-identified-differential gene expression changes, associated with rTg4510 phenotype and age, were validated with RNA-Seq reads}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=2,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\end{center}
	\captionsetup{width=0.95\textwidth}
...
\boldheader{Iso-Seq defined transcriptome enable identification of tau-pathology associated changes in genes not previously known in reference}
...
\begin{figure}[htp]
	\centering
	\includegraphics[page=1,trim={0 4cm 0 0}, scale = 0.45]{TracksFigures_Diff}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=11,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\end{center}
	\captionsetup{width=0.95\textwidth}
	\caption[Comparison of Known and Novel Isoforms from Iso-Seq Whole Transcriptome runs]%
...
\begin{figure}[!htp]
	\centering
	\includegraphics[page=4,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[page=12,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[page=18,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[page=19,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[page=15,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[page=17,trim={0cm 20cm 0cm 0cm},clip,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=10,trim={0cm 18cm 0cm 0cm},clip,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\end{center}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=9,scale = 0.55]{WholeDifferentialAnalysis.pdf}
	\end{center}
	\captionsetup{width=0.95\textwidth}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=2,scale = 0.55]{DIU_DEG_major}
	\end{center}
	\captionsetup{width=0.95\textwidth}
	\caption[\textit{Esyt2} was misidentified with differential isoform usage due to low Iso-Seq read counts]%
	{\textbf{\textit{Esyt2} was misidentified with differential isoform usage due to low Iso-Seq read counts}: \textbf{a)} Isoform expression (normalised counts) and \textbf{c)} subsequent deduction of isoform fraction of \textit{Esyt2} using Iso-Seq reads as expression, and the equivalent \textbf{b)} isoform expression and \textbf{d)} isoform fraction of the same gene, \textit{Esyt2} with RNA-Seq reads as expression. Iso-Seq reads were used as annotation in both analyses. 
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=3,scale = 0.55]{DIU_DEG_major}
	\end{center}
	\captionsetup{width=0.95\textwidth}
	\caption[\textit{Esyt2} was misidentified with differential isoform usage due to low Iso-Seq read counts]%
	{\textbf{\textit{Esyt2} was misidentified with differential isoform usage due to low Iso-Seq read counts}:}   
	\label{fig:DIU_esyt2}
\end{figure}

\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=4,scale = 0.55]{DIU_DEG_major}
	\end{center}
	\captionsetup{width=0.95\textwidth}
	\caption[\textit{Esyt2} was misidentified with differential isoform usage due to low Iso-Seq read counts]%
	{\textbf{\textit{Esyt2} was misidentified with differential isoform usage due to low Iso-Seq read counts}:}   
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[page=5,scale = 0.55]{DIU_DEG_major}
	\end{center}
	\captionsetup{width=0.95\textwidth}
	\caption[\textit{Esyt2} was misidentified with differential isoform usage due to low Iso-Seq read counts]%
	{\textbf{\textit{Esyt2} was misidentified with differential isoform usage due to low Iso-Seq read counts}:}   
...
\subsection{Target Transcriptome}
\begin{itemize}
...
\begin{landscape}
	\begin{table}[]
		\centering
		\begin{tabularx}{1.2\textwidth}{cccccccccc}
			\toprule
			\multicolumn{2}{c}{\multirow{3}{*}{Target Gene}} & \multicolumn{4}{c}{Whole Transcriptome   Analysis}                                                                                                            & \multicolumn{4}{c}{Targeted Transcriptome   Analysis}                                                                                                         \\ \cmidrule(l){3-10} 
			\multicolumn{2}{c}{}                             & \multicolumn{2}{c}{Differential Gene}                                         & \multicolumn{2}{c}{Differential Transcript}                                   & \multicolumn{2}{c}{Differential Gene}                                         & \multicolumn{2}{c}{Differential Transcript}                                   \\ \cmidrule(l){3-10} 
			\multicolumn{2}{c}{}                             & Iso-Seq                   & RNA-Seq                 & Iso-Seq                   & RNA-Seq                    & Iso-Seq               & RNA-Seq                & Iso-Seq                   & RNA-Seq                 \\ \midrule
			1                     & Abca1                    & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{green!25} \\
			2                     & Abca7                    & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			3                     & Ank1                     & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			4                     & Apoe                     & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{green!25} & \cellcolor{green!25} & \cellcolor{green!25} & \cellcolor{red!25}   \\
			5                     & App                      & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   \\
			6                     & Bin1                     & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			7                     & Cd33                     & \cellcolor{white!25} & \cellcolor{white!25} & \cellcolor{white!25} & \cellcolor{white!25} & \cellcolor{red!25} & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			8                     & Clu                      & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{green!25} \\
			9                     & Fus                      & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25} & \cellcolor{red!25}   \\
			10                    & Fyn                      & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			11                    & Mapt                     &                                       &                                       &                                       &                                       &                                       &                                       &                                       &                                       \\
			12                    & Picalm                   & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25} & \cellcolor{red!25}   \\
			13                    & Ptk2b                    & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   \\
			14                    & Rhbdf2                   & \cellcolor{white!25} & \cellcolor{white!25} & \cellcolor{white!25} & \cellcolor{white!25} & \cellcolor{red!25} & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			15                    & Snca                     & \cellcolor{red!25} & \cellcolor{red!25} & \cellcolor{red!25}   & \cellcolor{red!25} & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			16                    & Sorl1                    & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			17                    & Tardbp                   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			18                    & Trem2                    & \cellcolor{green!25} & \cellcolor{green!25} & \cellcolor{green!25} & \cellcolor{green!25} & \cellcolor{green!25} & \cellcolor{green!25} & \cellcolor{green!25} & \cellcolor{green!25} \\
			19                    & Trpa1                    & \cellcolor{white!25} & \cellcolor{white!25} & \cellcolor{white!25} & \cellcolor{white!25} & \cellcolor{red!25} & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   \\
			20                    & Vgf                      & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{red!25}   & \cellcolor{green!25} & \cellcolor{red!25}   & \cellcolor{red!25} & \cellcolor{red!25}   & \cellcolor{green!25} \\ \bottomrule
		\end{tabularx}
	\end{table}
\end{landscape}