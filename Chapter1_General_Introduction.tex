...
\begin{landscape}
	\begin{figure}[]
		...
		{\textbf{Significant advances in long-read sequencing technology \& approaches.} Shown is a timeline highlighting the major breakthroughs in long-read sequencing approaches of isoforms using Pacific Bioscience's (PacBio) Single molecule real-time sequencing (SMRT) (boxed blue) and Oxford Nanopore sequencing (ONT, boxed orange). Release of respective technologies are also marked.}
...
\begin{landscape}
	...
	\begin{longtable}[c]{p{4cm}p{4cm}p{18cm}}
		...
		{\textbf{Advances in Long-read sequencing technologies: single-cell RNA-Seq and Direct RNA-Seq.} Tabulated is a review of recent studies that leveraged the power of single-cell and direct RNA sequencing. DTE - differential transcript expression, ONT - Oxford Nanopore Technologies, SE - Skipped Exon, TSS - Transcription Start Site, TTS - Transcriptional Termination Site, }
