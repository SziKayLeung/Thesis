...
\begin{figure}[h]
	...
	\begin{subfigure}{0.4\linewidth}
		\includegraphics[width=\linewidth, height=0.15\textheight]{WTAC_Adapted_Gel1.png}
		\caption{Gel image of WTAC and optimised protocol}
	\end{subfigure}
	\hspace{2em}
	\begin{subfigure}{0.4\linewidth}
		\includegraphics[width=\linewidth, height=0.15\textheight]{WTAC_Adapted_Final.png}
