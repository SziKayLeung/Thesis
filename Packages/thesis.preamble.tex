...
\renewenvironment{abstract}{%
	\chapter*{\LARGE Abstract}\thispagestyle{plain}}{\cleardoublepage}

\usepackage{multicol} % list in multiple columns
...
\input{Packages/code.sty} % for including programming 
\input{Packages/blocked.sty}
\input{Packages/uhead.sty}
\input{Packages/boxit.sty}
\input{Packages/thesis.sty}
