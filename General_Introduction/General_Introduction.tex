...
\begin{figure}[!htp]
	...
	}https://www.overleaf.com/download/project/606c6abc16fe6d1943827fca/build/17b63765cd8-44d3a025dce1123d/output/output.pdf?compileGroup=priority&clsiserverid=clsi-pre-emp-e2-f-z887&popupDownload=true
...
\begin{changemargin}{1.5cm}
	\begin{landscape}
		\begin{figure}[]
			\includegraphics[page=1,trim={0 4cm 1.8cm 2cm},clip, scale = 0.8]{Introduction_Figures_Landscape.pdf}
	...
	\begin{landscape}
		...
		\begin{longtable}[c]{p{4cm}p{4cm}p{18cm}}
			...
			{\textbf{Long-read sequencing studies of single cells or direct RNA}}
...
\begin{enumerate}
	\item Optimise long-read sequencing approaches, PacBio's Iso-Seq and ONT cDNA sequencing, for profilling of full-length transcripts (\cref{ch: long_read_sequencing}) 
...
\begin{landscape}
	\begin{figure}[htb]
		\begin{center}
			\includegraphics[page=2,trim={0 0 0 0},clip,scale = 0.7]{Introduction_Figures_Landscape.pdf}
		\end{center}
