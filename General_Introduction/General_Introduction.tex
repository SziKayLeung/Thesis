...
\begin{figure}[!htp]
	\centering
	\includegraphics[page=1,trim={0 14cm 8cm 2cm},clip, scale = 0.8]{Introduction_Figures.pdf}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[page=2,trim={2cm 35cm 0 2cm},clip,scale = 0.55]{Introduction_Figures.pdf}
	\end{center}
	\captionsetup{width=0.95\textwidth}
